...
<html>
    ...
    <body>
        <div class="container main-section">
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12 right-sidebar">
                    <div class="row">
                      <!--getting user info who is logged in-->  
                      <?php
                      ...
                      <div class="col-md-12 right-header">
                          ...
                          <div class="right-header-detail">
                              <form method="post">
                                  ...
                                  <button name="videocall" class="btn btn-primary">videocall</button>
                              </form>
                              <?php
                        ...
                        <div id="scrolling_to_bottom" class="col-md-12 right-header-contentChat">
                            ...
                            <ul>
                                ...
                                if($user_name== $sender_username AND $username == $reciever_username){
                                    echo"<li><div class='rightside-right-chat'><span> $username <small>$msg_date</small></span><br><br><p>$msg_content</p></div></li> ";
                                  }
                                  else if($user_name== $reciever_username AND $username == $sender_username){
                                    echo"<li><div class='rightside-left-chat'><span> $username <small>$msg_date</small></span><br><br><p>$msg_content</p></div></li> ";
                                  }
                                ?>
                            </ul>
                            <?php
        ...
        if(isset($_POST['submit'])){
             ...
             if($msg ==""){
                 echo"<div class='alert alert-danger'> <strong><center>Message was enable to send</center></strong></div>";
                 
             }
             else if(strlen($msg)>100){
                 echo "<div class='alert alert-danger'><strong><center>Message is too long</center></strong></div>";
             }
             else{
